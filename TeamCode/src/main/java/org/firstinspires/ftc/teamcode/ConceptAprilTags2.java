...
@TeleOp(name = "Concept: AprilTag Easy (Fixed)", group = "Concept")
public class ConceptAprilTags2 extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        if (opModeIsActive()) {
            while (opModeIsActive()) {
                ...
                // Push telemetry to the Driver Station once per loop
                telemetry.update();
